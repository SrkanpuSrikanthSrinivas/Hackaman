...
import CommunityPage, { PostReaderPage } from "./CommunityPage.jsx";
...
function LoginPage({ onLogin }) {
  ...
  const FF2 = {fontFamily:"'Inter',system-ui,sans-serif"};
  ...
  const features = [
    { icon:"🏗️", text:"Create and manage hackathon events" },
    { icon:"⚖️", text:"Assign judges and track scoring" },
    { icon:"🤖", text:"AI-powered judging insights" },
    { icon:"🎓", text:"Certificates, mentors and check-in" },
      ...
      <div className="hf-login-grid" style={{ width:"100%", maxWidth:920,
        ...
        <div className="hf-login-brand" style={{
          ...
          <div style={{position:"relative"}}>
            ...
            <h1 style={{ fontSize:30,fontWeight:800,color:"#fff",lineHeight:1.2,
              letterSpacing:"-0.03em",marginBottom:12 }}>
              Run brilliant<br/>hackathons.
            </h1>
            <p style={{ fontSize:14,color:"rgba(255,255,255,0.5)",lineHeight:1.7,marginBottom:36 }}>
              The complete platform for organizing world-class innovation events.
            </p>
            {features.map((f,i)=>(
          ...
          <div style={{position:"relative",marginTop:32}}>
            <p style={{fontSize:11,color:"rgba(255,255,255,0.2)",lineHeight:1.7}}>
              © {new Date().getFullYear()} HackFest Hub · Admin access<br/>
              Teams &amp; Judges sign in from their hackathon page
            </p>
          </div>
        </div>
        ...
        <div style={{ background:"#fff", padding:"48px 40px",
          ...
          <div style={{marginBottom:32}}>
            <h2 style={{fontSize:24,fontWeight:800,color:"#111827",
              letterSpacing:"-0.03em",marginBottom:6,...FF2}}>Welcome back</h2>
            <p style={{fontSize:14,color:"#6b7280",...FF2}}>Sign in to your organizer account</p>
          </div>
          ...
          {err && (
            <div style={{ display:"flex",alignItems:"flex-start",gap:10,
              ...
              <span style={{fontSize:13,color:"#991b1b",lineHeight:1.5,...FF2}}>{err}</span>
            </div>
          )}
          ...
          <form onSubmit={submit} style={{display:"flex",flexDirection:"column",gap:18,minWidth:0}}>
            <div>
              ...
              <div style={{position:"relative"}}>
                ...
                <input type="email" required autoFocus value={email}
                  ...
                  style={{...FF2,width:"100%",paddingLeft:38,paddingRight:14,
            ...
            <div>
              ...
              <div style={{position:"relative"}}>
                ...
                <input type={showPass?"text":"password"} required value={pass}
                  ...
                  style={{...FF2,width:"100%",paddingLeft:38,paddingRight:44,
                    paddingTop:11,paddingBottom:11,borderRadius:10,fontSize:14,
                    color:"#111827",background:"#f9fafb",
                    border:"1.5px solid #e5e7eb",outline:"none",transition:"all 0.15s"}}
                  onFocus={e=>e.target.style.borderColor="#4f46e5"}
                ...
                <button type="button" onClick={()=>setShowPass(!showPass)}
                  style={{position:"absolute",right:12,top:"50%",
                    ...
                    border:"none",cursor:"pointer",fontSize:16,color:"#9ca3af",padding:2}}>
                  {showPass?"🙈":"👁"}
                </button>
              </div>
            </div>
            ...
            <button type="submit" disabled={loading}
              style={{...FF2,width:"100%",padding:"13px",borderRadius:10,
          ...
          <div style={{marginTop:24,padding:"14px 16px",
            ...
            <p style={{fontSize:12,color:"#64748b",lineHeight:1.7,margin:0,...FF2}}>
...
function AppShell() {
  ...
  // ── SUSPENSION GATE — only a suspended workspace is blocked ──────────────
  const orgFrozen = currentUser.orgId && currentUser.orgId !== "org_default"
    && liveOrgStatus === "suspended";
  if (orgFrozen) {
    return (
          ...
          <div style={{display:"flex",gap:10,justifyContent:"center"}}>
            <button onClick={()=>window.location.reload()}
              style={{padding:"10px 22px",background:"#111827",color:"#fff",border:"none",
                borderRadius:9,fontSize:13,fontWeight:600,cursor:"pointer"}}>Check again</button>
            <button onClick={logout}
              style={{padding:"10px 22px",background:"#f9fafb",color:"#374151",
                border:"1px solid #d1d5db",borderRadius:9,fontSize:13,fontWeight:500,cursor:"pointer"}}>Sign out</button>
          </div>
...
export default function App() {
  ...
  if (path === "/signup" || path === "/start") return <ErrorBoundary><SignupPage /></ErrorBoundary>;
  if (path === "/community")         return <ErrorBoundary><CommunityPage /></ErrorBoundary>;
